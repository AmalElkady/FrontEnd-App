    ...
    <div className="animated slideInUpTiny animation-duration-3">
      <div className="filter-with-bg-color text-center">
        <ContainerHeader
          ...
          title={<IntlMessages id="extraPages.ourClients" />}
          match={match}
        />
        ...
        <ul className="list-inline">
          ...
          <li>
            <span className="jr-link">
              <IntlMessages id="extraPages.graphicDesign" />
            </span>
          </li>
          <li>
            <span className="jr-link">
              <IntlMessages id="extraPages.logo" />
            </span>
          </li>
          <li>
            <span className="jr-link">
              <IntlMessages id="extraPages.mobileApp" />
            </span>
          </li>
          <li>
            <span className="jr-link">
              <IntlMessages id="extraPages.web" />
            </span>
          </li>
        </ul>
      </div>
