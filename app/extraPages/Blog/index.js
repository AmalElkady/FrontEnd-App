...
const Blog = ({ match }) => {
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      <ContainerHeader
        title={<IntlMessages id="sidebar.extraPages.blog" />}
        match={match}
      />
      <div className="row">
            ...
            <div className="card-body">
              ...
              <div className="meta-wrapper">
                ...
                <span className="meta-comment">
                  <i className="zmdi zmdi-comment-text zmdi-hc-lg" />
                  23 Comments
                </span>
              </div>
              <p className="card-text">
                It’s no secret that the digital industry is booming. From
                exciting startups to global brands, out to digital agencies,
                responding to the new possibilities available. However, the
                industry overcrowded, heaving with agencies offering similar
                services — on the surface, at least. projects is the key to
                standing out. Unique side projects are the best place to
                innovate, but creatively lucrative work is tricky. So, this
                article looks at …
              </p>
          ...
          <nav aria-label="Page navigation example">
            <ul className="pagination justify-content-center my-3 my-sm-5">
              <li className="page-item disabled">
                <span className="page-link jr-link" tabIndex="-1">
                  Previous
                </span>
              </li>
              <li className="page-item">
                <span className="page-link jr-link">1</span>
              </li>
              <li className="page-item">
                <span className="page-link jr-link">2</span>
              </li>
              <li className="page-item">
                <span className="page-link jr-link">3</span>
              </li>
              <li className="page-item">
