...
class SweetAlerts extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <ContainerHeader
          title={<IntlMessages id="extension.sweetAlerts" />}
        ...
        <div className="row mb-md-3">
          ...
          >
            ...
            >
              <IntlMessages id="sweetAlerts.basic" />
            </Button>
          </CardBox>
          ...
          >
            ...
            >
              <IntlMessages id="sweetAlerts.description" />
            </Button>
          </CardBox>
        ...
        <div className="row mb-md-3">
          ...
          >
            ...
            >
              <IntlMessages id="sweetAlerts.custom" />
            </Button>
          </CardBox>
          ...
          >
            ...
            >
              <IntlMessages id="sweetAlerts.htmlTag" />
            </Button>
          </CardBox>
          ...
          >
            ...
            >
              <IntlMessages id="sweetAlerts.prompt" />
            </Button>
          </CardBox>
          ...
          >
            ...
            >
              <IntlMessages id="sweetAlerts.passwordPrompt" />
            </Button>
          </CardBox>
        </div>
        ...
        <div className="row mb-md-3">
          ...
          >
            ...
            >
              <IntlMessages id="sweetAlerts.customStyle" />
            </Button>
          </CardBox>
        </div>
        <SweetAlert
        ...
        >
          <IntlMessages id="sweetAlerts.basic" />
          {<IntlMessages id="sweetAlerts.writeSomething" />}
        </SweetAlert>
        <SweetAlert
          show={password}
          input
