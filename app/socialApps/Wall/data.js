...
export const communityList = [
  ...
  },
  {
    id: 4,
    title: "Magic Tricks",
    image: "https://via.placeholder.com/600x330",
    postCount: 0
  },
  {
    id: 5,
    ...
    commentList: [
      {
        user: {
          id: 1,
          name: "Kenery Thomson",
          image: "https://via.placeholder.com/124x106"
        },
        comment:
          "Wow ! Excellent I particularly like the use of whitespace here Keep it up",
    ...
    tasks: [
      {
        ...
        title: [
          "Agent ",
          <span key={6} className="jr-link">
            Kily Johns
          </span>,
          " has added 7 new photos to the property ",
          <span key={7} className="jr-link">
            Albama’s House
          </span>
        ],
        avatar: "",
      ...
      },
      {
        ...
        name: "Oliver Shorter",
        title: [
          <span key={9} className="jr-link">
            Oliver Shorter
          </span>,
          " is looking for an office space in ",
          <span key={10} className="jr-link">
            Colorado, USA
          </span>
        ],
        avatar: "https://via.placeholder.com/150x150",
