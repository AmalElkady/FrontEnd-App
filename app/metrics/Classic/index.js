...
import {
  ...
  data2,
  radarChartData
} from "../../../app/dashboard/ECommerce/data";
import {
  chartData,
  lineChartData,
  pieChartData
} from "../../../app/dashboard/News/data";
    ...
    return (
      <div className="animated slideInUpTiny animation-duration-3">
        <ContainerHeader
          ...
          title={<IntlMessages id="sidebar.metrics" />}
        />
        <div className="row">
        ...
        <div className="row">
          ...
          <div className="col-xl-3 col-lg-6 col-md-3 col-sm-6 col-12">
            <div className="jr-card bg-primary text-white text-center py-5">
              <div className="mb-3">
                <img
                  src={require("../../../static/images/dashboard/download.png")}
                  alt="downloadImage"
                />
              </div>
