      ...
      <Widget styleName="jr-card-full">
        <div className="row">
          <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
            <div className="jr-slick-slider-lt-thumb">
              <img
                className={
                  this.state.loading ? "fadeout img-fluid" : "fadein img-fluid"
                }
          ...
          <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
            <Slider
              className="jr-slick-slider jr-slick-slider-dot-top"
              {...settings}
              afterChange={index => {
                this.setState({
                  loading: false,
                  image: greenStepList[index].image
                });
              }}
