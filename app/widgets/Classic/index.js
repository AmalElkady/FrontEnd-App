...
import {
  dailyFeedData,
  recentList
} from "../../../app/dashboard/Intranet/data";
        ...
        <div className="row">
          <div className="col-lg-8 col-12">
            <div className="jr-card">
              ...
              <span className="jr-link card-link text-uppercase">
                all products
              </span>
            </div>
          </div>
                ...
                <div className="jr-card pb-2">
                  ...
                  <div className="jr-card-social">
                    <ul className="social-link">
                      <li>
                        <span className="jr-link text-secondary text-lighten-2">
                          <i className="zmdi zmdi-favorite" />
                        </span>
                      </li>
                      <li>
                        <span className="jr-link">
                          <i className="zmdi zmdi-bookmark" />
                        </span>
                      </li>
                      <li>
                        <span className="jr-link">
            ...
            <div className="jr-card">
              <div className="jr-card-header d-flex">
                <div className="mr-auto">
                  ...
                  <p className="sub-heading">
                    Lorem ipsum is dummy content dollar sit is...
                  </p>
                </div>
