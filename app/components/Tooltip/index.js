...
const Tooltips = ({ match }) => {
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      <ContainerHeader
        title={<IntlMessages id="sidebar.components.tooltips" />}
        match={match}
      />
      <div className="row">
        <CardBox
          styleName="col-xl-3 col-md-3 col-sm-6 col-12 text-center"
      ...
      <div className="row">
        <CardBox
          styleName="col-xl-12"
          heading={<IntlMessages id="component.tooltips.positioned" />}
        >
          <PositionedTooltips />
        </CardBox>
      </div>
