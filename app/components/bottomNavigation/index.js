...
const BottomNavigation = ({ match }) => {
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      <ContainerHeader
        title={<IntlMessages id="sidebar.components.bottomNavigation" />}
        match={match}
      />

      <div className="row">
        <CardBox
          styleName="col-lg-4 col-md-6 col-12"
        ...
        <CardBox
          styleName="col-lg-4 col-md-6 col-12 order-lg-3"
          heading={
            <IntlMessages id="component.bottomNavigation.withActiveLabels" />
          }
          headerOutside
        >
        ...
        <CardBox
          styleName="col-lg-4 col-md-12 col-12"
          heading={
            <IntlMessages id="component.bottomNavigation.withNoLabels" />
          }
          headerOutside
        >
