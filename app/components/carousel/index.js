...
const Carousel = ({ match }) => (
  <div className="animated slideInUpTiny animation-duration-3">
    <ContainerHeader
      title={<IntlMessages id="sidebar.components.carousel" />}
      match={match}
    />
    ...
    <div className="row mb-md-3">
      <CardBox
        styleName="col-lg-12"
        heading={<IntlMessages id="component.carousel.basic" />}
      >
        <div>
          <IntlMessages id="component.carousel.basicTxt" />
        </div>
        <Simple />
      </CardBox>
    </div>
    ...
    <div className="row mb-md-3">
      ...
      >
        <div>
          <IntlMessages id="component.carousel.productTxt" />
        </div>
