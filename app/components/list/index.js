...
import SimpleList from "./dividers";
import FolderList from "./folder";
import InsetList from "./inset";
...
import PinnedSubheaderList from "./pinnedSubHeader";
import CardBox from "../../../components/CardBox";
import ContainerHeader from "../../../components/ContainerHeader";
import CheckBoxListControl from "./checkBoxListControl";
import ListDividers from "../../../app/components/dividers/list";
...
const Lists = ({ match }) => {
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      <ContainerHeader
        title={<IntlMessages id="sidebar.components.lists" />}
        match={match}
      />
