      ...
      <div>
        ...
        <Grid className="row">
          <Grid item className="col-xs-12 col-sm-6">
            <h3 className="text-gray lighten-2 my-3">Text only</h3>
          ...
          <Grid item className="col-xs-12 col-sm-6">
            <h3 className="text-gray lighten-2 my-3">Icon with text</h3>
            <div className="jr-card p-0">
              <List dense={dense}>
                {generate(
                  <ListItem button>
        ...
        <Grid className="row">
          <Grid item className="col-xs-12 col-sm-6">
            <h3 className="text-gray lighten-2 my-3">Avatar with text</h3>
            <div className="jr-card p-0">
              <List dense={dense}>
                {generate(
                  <ListItem button>
