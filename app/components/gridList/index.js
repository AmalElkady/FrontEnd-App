...
import TitlebarGridList from "./titlebars";
import SingleLineGridList from "./singleLine";
import AdvancedGridList from "./advance";
...
const GridLists = ({ match }) => {
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      <ContainerHeader
        title={<IntlMessages id="sidebar.components.gridList" />}
        match={match}
      />
