    ...
    <div className="animated slideInUpTiny animation-duration-3">
      ...
      <div className="row mb-md-3">
        <CardBox
          styleName="col-12"
          cardStyle="p-0"
          heading={<IntlMessages id="component.drawer.persistent" />}
          headerOutside
        >
          <PersistentDrawer />
        </CardBox>
      ...
      <div className="row mb-md-3">
        <CardBox
          styleName="col-12"
          cardStyle="p-0"
          heading={<IntlMessages id="component.drawer.permanent" />}
          headerOutside
        >
          <PermanentDrawer />
        </CardBox>
      ...
      <div className="row mb-md-3">
        <CardBox
          styleName="col-12"
          cardStyle="p-0"
          heading={<IntlMessages id="component.drawer.mini" />}
          headerOutside
        >
          <MiniDrawer />
        </CardBox>
      ...
      <div className="row">
        <CardBox
          styleName="col-12"
          cardStyle="p-0"
          heading={<IntlMessages id="component.drawer.responsive" />}
          headerOutside
        >
          <ResponsiveDrawer />
        </CardBox>
