...
const ButtonGroup = ({ match }) => {
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      <ContainerHeader
        title={<IntlMessages id="sidebar.components.buttonGroup" />}
        match={match}
      />
      ...
      <div className="row">
        <CardBox
          styleName="col-xl-4 col-md-6 col-12"
          heading={<IntlMessages id="component.buttonGroup.default" />}
        >
          <div>
            <IntlMessages id="component.buttonGroup.defaultStyle" />
          </div>
        ...
        >
          <div>
            <IntlMessages id="component.buttonGroup.flatStyle" />
          </div>
          <FlatButtonGroup />
        </CardBox>
        ...
        <CardBox
          styleName="col-xl-4 col-md-6 col-12"
          heading={<IntlMessages id="component.buttonGroup.highlighted" />}
        >
          <div>
            <IntlMessages id="component.buttonGroup.highlightedStyle" />
          </div>
        ...
        <CardBox
          styleName="col-xl-4 col-md-6 col-12"
          heading={<IntlMessages id="component.buttonGroup.iconFlat" />}
        >
          <div>
            <IntlMessages id="component.buttonGroup.defaultStyle" />
          </div>
      ...
      <div className="row">
        <CardBox
          styleName="col-xl-4 col-md-4 col-sm-6 col-12"
