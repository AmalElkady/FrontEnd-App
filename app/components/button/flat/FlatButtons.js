  ...
  return (
    <div>
      <div className="jr-btn-group">
        ...
        <Button className="jr-btn" color="primary" disabled>
          Disabled
        </Button>
      </div>
      ...
      <div>
        ...
        <Button
          variant="contained"
          className="jr-btn bg-secondary text-uppercase text-white btn-block"
        >
          Full Width large button
        </Button>
        <Button
          variant="contained"
          className="jr-btn bg-white text-uppercase text-black btn-block"
        >
          Full Width default button
        </Button>
        <Button className="jr-btn text-uppercase btn-block" color="default">
          Full Width default button
        </Button>
      </div>
    </div>
