  ...
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      ...
      <div className="row mb-md-3">
        ...
        >
          <div>
            <IntlMessages id="component.buttons.iconTxt" />
          </div>
          <IconButtons />
        </CardBox>
      </div>
      ...
      <div className="row mb-md-3">
        ...
        >
          <div>
            <IntlMessages id="component.buttons.differentSizesTxt" />
          </div>
        ...
        >
          <div>
            <IntlMessages id="component.buttons.flatFullWidthTxt" />
          </div>
          <FlatButtons />
        </CardBox>
      </div>
      ...
      <div className="row mb-md-3">
        ...
        >
          <div>
            <IntlMessages id="component.buttons.raisedTxt" />
          </div>
          <Raised />
        </CardBox>
        ...
        >
          <div>
            <IntlMessages id="component.buttons.fabTxt" />
          </div>
          <FAB />
        </CardBox>
      </div>
      ...
      <div className="row mb-md-3">
        ...
        >
          <div>
            <IntlMessages id="component.buttons.socialMediaTxt" />
          </div>
          <SocialMediaButtons />
        </CardBox>
      </div>
