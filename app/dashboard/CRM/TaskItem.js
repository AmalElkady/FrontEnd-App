      ...
      <div className="media jr-task-list-item align-items-sm-center flex-nowrap">
        ...
        <div className="media-body jr-task-item-content">
          <div className="jr-task-item-content-left">
            <p
              className={`text-truncate mb-0 ${
                completed ? "text-strikethrough" : "jr-text-hover"
              }`}
            >
              {title}
            </p>
          ...
          <div className="jr-task-item-content-right">
            ...
            <span className="bg-grey text-white px-2 jr-fs-sm ml-2 mb-0 rounded-xl order-sm-2">
              {user.projectName}
            </span>
            <ul className="jr-dot-list mb-0 order-sm-1 ml-2">
              {getTags(tags)}
            </ul>
            <span className="jr-fs-sm text-grey ml-3 jr-task-date order-sm-4">
              {dueDate}
            </span>
          </div>
        </div>
