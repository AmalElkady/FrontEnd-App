        ...
        <div className="jr-featured-content-left">
          ...
          <div className="d-flex flex-wrap mb-2">
            <p className="mr-3 mb-1">
              <span className="text-grey">Bedrooms:</span> {bedrooms}
            </p>
            <p className="mr-3 mb-1">
              <span className="text-grey">Baths:</span> {baths}
            </p>
            <p className="mr-3 mb-1">
              <span className="text-grey">Area:</span> {area}
            </p>
            <a className="text-grey text-underline" href="#/">
              {" "}
              + {more} more
            </a>
          </div>
