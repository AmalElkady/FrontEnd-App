...
export const dailyFeedData = [
  ...
  },
  {
    ...
    desc: [
      ...
      ' has shared a post saying "This is bigening."'
    ],
    image: "https://via.placeholder.com/150x150",
    time: "Today 06:30 pm - 12.10.17",
...
export const announcementsNotification = [
  ...
  },
  {
    ...
    title: "Invitation",
    desc: [
      <span className="jr-link" key={15}>
        Guptil
      </span>,
      " has sent you an invitation to join project ",
      <span className="jr-link" key={16}>
        Mouldifi
      </span>
    ],
    image: "https://via.placeholder.com/150x150"
...
export const todoData = [
  ...
  },
  {
    id: 3,
    notes:
      "Bring the latest idea to the digital paper and send this for the selection.",
    selected: false
  },
  {
    id: 4,
