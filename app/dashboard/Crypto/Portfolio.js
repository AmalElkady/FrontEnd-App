      ...
      <div className="row">
        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
          <div className="d-flex mb-2">
            <h2 className="mr-2 mb-0 jr-fs-xxxl jr-font-weight-medium">
              $179,626
            </h2>
            <h5 className="mb-0 pt-2 jr-chart-up">
              64% <i className="zmdi zmdi-caret-up" />
            </h5>
          </div>
          <p className="text-grey mb-4">Overall balance</p>
          <div className="d-flex flex-row mb-3">
            <Button
              className="mr-2 jr-btn jr-btn-sm"
              variant="contained"
              color="primary"
            >
              Deposit
          ...
          <p className="d-inline-flex align-items-center mb-0 text-primary pointer d-none d-sm-block">
            <i className="zmdi zmdi-plus-circle-o" /> Add New Wallet
          </p>
        </div>
        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
