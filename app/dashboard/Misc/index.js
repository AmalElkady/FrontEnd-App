...
import SimpleToDo from "../../../components/ToDoCard";
...
import PhotoCollage from "../../../components/dashboard/Common/PhotoCollage";
...
import YourDailyFeed from "../../../components/dashboard/Common/DailyFeed";
import TimerView from "../../../components/dashboard/Common/TimerView";
import ContactCard from "../../../components/Cards/Contact";
import SimpleCard from "../../../components/Cards/Sample";
import PopularProduct from "../../../components/dashboard/Common/PopularProduct";
import WeatherDetail from "../../../components/Weather/WeatherDetail";
import LatestPosts from "../../../components/dashboard/Common/LatestPosts";
import {
...
import CafeCard from "../../../components/Cards/Cafe";
...
import Team from "../../../app/extraPages/aboutUs/Componets/Team";
...
import "./test.css";
import GradientSVG from "../../../app/dashboard/Misc/GradientSVG";
import CustomLineChart from "../../../components/CustomLineChart/index";
import { Progress } from "reactstrap";
import MapWithASearchBox from "../../map/MapWithSearchBox/Components/MapWithASearchBox";
    ...
    return (
      <div className="dashboard animated slideInUpTiny animation-duration-3">
          ...
          <div className="col-xl-5 col-12">
            <div className="jr-card p-0">
              <div className="jr-card-header pt-4 px-4 mb-1">
                <h3 className="mb-0">
                  <IntlMessages id="dashboard.userStatstics" />
                </h3>
              </div>
          ...
          <div className="col-xl-7 col-12">
            <div className="row">
              ...
              <div className="col-xl-5 col-lg-6 col-sm-5 col-12">
                <ChartCard
                  styleName="jr-chart-or"
                  chartHeaderStyle="pl-3 pr-2 pt-3 mb-2"
                >
                  <div className="chart-title d-flex">
                    ...
                    <IconButton className="icon-btn-sm p-1 jr-fs-lg">
        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-sm-6 col-12">
            <div className="jr-card jr-full-card">
              <CardHeader heading="New Connections" subHeading="3 This week" />
          ...
          <div className="col-lg-5 col-sm-6 col-12">
            <div className="jr-card">
              <CardHeader
                heading={<IntlMessages id="dashboard.recentActivities" />}
                subHeading={<IntlMessages id="dashboard.lastActivity" />}
              />

              {recentList.map((recentList, index) => (
                <RecentActivities key={index} recentData={recentList} />
              ))}
            </div>
          </div>
          ...
          <div className="col-lg-4 col-sm-6 col-12">
            <div className="jr-card pb-4">
              <div className="jr-card-header mb-3 d-flex align-items-center">
                <h3 className="mb-0 mr-auto">
                  <IntlMessages id="dashboard.currentProjects" />
                </h3>
              ...
              <div className="jr-card-header d-flex align-items-center">
                <div className="mr-auto">
                  <h3 className="card-heading d-inline-block mb-0">
                    <IntlMessages id="dashboard.toDoItems" />
                  </h3>
                </div>
                <span className="badge badge-secondary">
            ...
            <div className="jr-card jr-full-card">
              <div className="jr-card-header d-flex align-items-center pb-3">
                <h3 className="card-heading mb-0">
                  <i className="zmdi zmdi-chart-donut zmdi-hc-fw mr-2" />
          ...
          <div className="col-lg-5 col-md-12 col-sm-6 col-12">
            <div className="jr-card jr-full-card">
              <div className="jr-card-header d-flex align-items-center">
                <div className="mr-auto">
                  <h3 className="card-heading d-inline-block mb-0">
                    <IntlMessages id="dashboard.yourDailyFeed" />
                  </h3>
                </div>
                <span className="badge badge-secondary">
                  <IntlMessages id="dashboard.newFeed" />
                </span>
              </div>
              <YourDailyFeed data={dailyFeedData} />
              <div className="daily-feed-footer">
                <span className="jr-link card-link">
                  <IntlMessages id="dashboard.viewAll" />
                </span>
              </div>
            </div>
          </div>
                ...
                <div className="col-sm-8 col-12 text-sm-left text-center align-self-center">
                  <div className="jr-card-header mb-2">
                    <h3 className="card-heading">
                      <IntlMessages id="dashboard.googleInsight" />
                    </h3>
                    <p className="sub-heading">
                      <IntlMessages id="dashboard.lastCalculated" />
                    </p>
                  </div>
                  <Button
                    variant="contained"
                    className="text-uppercase jr-btn-sm"
                    color="primary"
                  >
                    <i className="zmdi zmdi-refresh-sync zmdi-hc-fw " />
                    <span>
                      <IntlMessages id="dashboard.refresh" />
                    </span>
                  </Button>
                </div>
              </div>
          ...
          <div className="col-lg-2 col-sm-4 col-12">
            <div className="jr-card bg-gradient-primary text-white text-center">
              <div className="mb-3 mt-xl-1">
                <img
                  src={"static/images/dashboard/download.png"}
                  alt="download1"
                />
              </div>
              <h5 className="text-uppercase mb-xl-1">
                <IntlMessages id="dashboard.upgradeToday" />
              </h5>
            </div>
          </div>
        </div>
          ...
          <div className="col-lg-3 col-sm-6 col-12">
            <ChartCard styleName="bg-gradient-primary text-white">
              <div className="chart-title">
                ...
                <p>
                  <IntlMessages id="dashboard.onlineSignups" />
                </p>
              </div>
          ...
          <div className="col-lg-5 col-sm-6 col-12">
            <div className="jr-card">
              <div className="jr-card-header d-flex align-items-center">
                <div className="mr-auto">
                  <h3 className="card-heading">
                    <IntlMessages id="dashboard.latestPosts" />
                  </h3>
                  <p className="sub-heading">
                    <IntlMessages id="dashboard.loremIpsum" />
                  </p>
                </div>
              ...
              <div>
                <span className="jr-link card-link jr-fs-13 text-uppercase">
                  <IntlMessages id="dashboard.viewAllPosts" />{" "}
                </span>
              </div>
            </div>
          </div>
                ...
                <div className="jr-card pb-2">
                  <div className="jr-card-thumb">
                    <img
                      ...
                      src={"https://via.placeholder.com/268x164"}
                      alt="toa-heftiba"
                    />
                  </div>
        ...
        <div className="row">
          <div className="col-lg-8 col-12">
            <div className="jr-card">
              <div className="jr-card-header d-flex align-items-center">
                <div className="mr-auto">
                  <h3 className="card-heading">
                    <IntlMessages id="dashboard.popularProducts" />
                  </h3>
                  <p className="sub-heading">
                    <IntlMessages id="dashboard.popularProductsTxt" />
                  </p>
                </div>
              ...
              <span className="card-link text-uppercase">
                <IntlMessages id="dashboard.allProducts" />{" "}
              </span>
            </div>
          </div>
          ...
          <CardBox
            styleName="col-lg-8 col-12"
            heading="Site Visitors Statistics"
          >
            <div>
              Lorem ipsum is dummy content Cenas in erat accumsan, hendrerit
              lorem vel, pulvinar odio. Quisque eu conva. hendrerit lorem vel,
              pulvinar odio. Quisque eu conva.
            </div>
            <SiteVisitor
              children={
                <VectorMap
