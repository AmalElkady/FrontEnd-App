...
import labels from "../../../app/todo/data/labels";
import { DatePicker } from "material-ui-pickers";
import users from "../../../app/todo/data/users";
    ...
    return (
      <div className="module-detail module-list">
        <CustomScrollbars
          ...
          style={{
            height:
              width >= 1200 ? "calc(100vh - 335px)" : "calc(100vh - 311px)"
          }}
        >
            ...
            <div className="row">
              <div className="col-sm-6 col-md-8">
                <div className="d-flex align-items-center">
                  ...
                  >
                    {user === null ? (
                      <h4 className="mb-0 mouse pointer">Assign User </h4>
                    ) : (
              ...
              <div className="col-sm-6 col-md-4">
                <div className="d-flex flex-sm-row-reverse justify-content-between justify-content-sm-start">
                  <Menu
                    id="label-menu"
          ...
          <div className="module-detail-item">
            ...
            <div className="form-group d-flex align-items-center mb-0">
              ...
              {editTitle ? (
                ...
                <div className="d-flex align-items-center w-100">
                  <div className="task-title col">{title}</div>
                  <IconButton
                    className="icon-btn"
          ...
          <div className="module-detail-item mb-4">
            {editNote ? (
              ...
              <div className="d-flex align-items-center w-100">
                <div className="task-des col px-0">{notes}</div>
                <IconButton className="icon-btn" onClick={this.handleEditNote}>
                  <i className="zmdi zmdi-edit" />
                </IconButton>
              </div>
