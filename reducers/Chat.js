...
import users from "../app/chatPanel/data/chatUsers";
import conversationList from "../app/chatPanel/data/conversationList";
import {
  ...
  switch (action.type) {
    ...
    case ON_SELECT_USER: {
      return {
        ...
        conversation: state.conversationList.find(
